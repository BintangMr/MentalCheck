...
@section('breadcrumb')
    ...
    <i data-feather="chevron-right" class="breadcrumb__icon"></i>
    <a href="{{ route('admin.question.answer.create',[$category_id, $soal_id]) }}" class="breadcrumb--active">Tambah Jawaban</a>
@endsection

@section('subhead')
    <title>Mental Check | Admin Tambah Jawaban</title>
@endsection

@section('subcontent')
    <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
        <h2 class="text-lg font-medium mr-auto">Tambah Jawaban</h2>
    </div>
    ...
    <script>
        cash(function () {
            async function simpan() {
                ...
                axios.post('{{ route('admin.question.answer.store',[$category_id,$soal_id]) }}', {
                    jawaban: jawaban,
                    poin: poin,
                    soal_id: {{ $soal_id }},
                }).then(res => {
