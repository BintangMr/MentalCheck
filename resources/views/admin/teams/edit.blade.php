...
@section('breadcrumb')
    ...
    <i data-feather="chevron-right" class="breadcrumb__icon"></i>
    <a href="{{ route('admin.teams.edit',$team->id) }}" class="breadcrumb--active">Edit Team</a>
@endsection
            ...
            <form id="form">
                <div>
                    ...
                    <input id="nama" required type="text" class="form-control nama__input"
                           placeholder="Nama" value="{{ $team->name }}">
                ...
                <div>
                    ...
                    <input id="role" required type="text" class="form-control role__input"
                           placeholder="Role" value="{{ $team->role }}">
                ...
                <div>
                    ...
                    <input id="facebook" required type="text" class="form-control facebook__input"
                           placeholder="Facebook" value="{{ $team->facebook }}">
                ...
                <div>
                    ...
                    <input id="twitter" required type="text" class="form-control twitter__input"
                           placeholder="Twiiter" value="{{ $team->twitter }}">
                ...
                <div>
                    ...
                    <input id="whatsapp" required type="text" class="form-control whatsapp__input"
                           placeholder="Whatsapp" value="{{ $team->whatsapp }}">
    ...
    <script>
        cash(function () {
            async function simpan() {
                ...
                axios.post('{{ route('admin.teams.update',$team->id) }}', formData, {
                    headers: {
            ...
            $("#image").fileinput({
                ...
                defaultPreviewContent: '<img src="{{ $team->image }}" alt="Avatar"><h6 class="text-muted">Klik untuk mengganti</h6>',
